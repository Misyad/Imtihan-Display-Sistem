  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8 transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        {/* Header */}
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-card/50 backdrop-blur-md p-6 rounded-3xl border border-border shadow-sm">
          ...
          <div className="flex flex-wrap items-center gap-4">
            {/* Legend */}
            <div className="flex items-center gap-4 bg-muted px-4 py-2 rounded-2xl text-xs font-bold uppercase tracking-wider">
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="p-3 rounded-2xl bg-muted text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-all active:scale-95"
                title="Reset All"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-card rounded-3xl p-8 border border-border shadow-sm flex flex-col justify-center items-center text-center space-y-2">
            ...
            <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Total Selesai</h3>
        ...
        {/* The Grid */}
        <div className="bg-card/50 backdrop-blur-md rounded-[2.5rem] p-6 md:p-10 border border-border shadow-inner">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    "border-2",
                    !isActive && !isUsed && hasData && "bg-card dark:bg-card border-border text-foreground dark:text-emerald-400 hover:border-emerald-500 hover:shadow-lg hover:shadow-emerald-500/10 cursor-pointer",
                ...
                >
                  ...
                  {isUsed && !isActive && (
                    <CheckCircle2 className="absolute -top-1.5 -right-1.5 w-4 h-4 text-white bg-rose-600 rounded-full border-2 border-white dark:border-card" />
                  )}
                  {isActive && (
        ...
        {/* Footer info */}
        <footer className="text-center py-6 text-muted-foreground/70 text-xs font-bold uppercase tracking-[0.2em]">
